...
void Draw()
{
	...
	pr2d_Rect( inputRect.X, inputRect.Y, inputRect.W, inputRect.H, 0xFFFFFF, 255 );
	if ( trackInput )
	{
...
void Timer()
{
	...
	if ( mouse_Click( M_BLEFT ) && col2d_PointInRect( (float)mouse_X(), (float)mouse_Y(), inputRect ) )
	{
		trackInput = TRUE;
